...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <head>
        ...
        <script language="javascript" type="text/javascript" src="<%=BundleTable.Bundles.ResolveBundleUrl("~/rdp/js/dialog.js", true)%>"></script>
        <script language="javascript" type="text/javascript" src="<%=BundleTable.Bundles.ResolveBundleUrl("~/rdp/js/display.js", true)%>"></script>
        <script language="javascript" type="text/javascript" src="<%=BundleTable.Bundles.ResolveBundleUrl("~/rdp/js/display/canvas.js", true)%>"></script>
        <script language="javascript" type="text/javascript" src="<%=BundleTable.Bundles.ResolveBundleUrl("~/rdp/js/display/divs.js", true)%>"></script>
        <script language="javascript" type="text/javascript" src="<%=BundleTable.Bundles.ResolveBundleUrl("~/rdp/js/display/terminaldiv.js", true)%>"></script>
        <script language="javascript" type="text/javascript" src="<%=BundleTable.Bundles.ResolveBundleUrl("~/rdp/js/network.js", true)%>"></script>
        <script language="javascript" type="text/javascript" src="<%=BundleTable.Bundles.ResolveBundleUrl("~/rdp/js/network/buffer.js", true)%>"></script>
        <script language="javascript" type="text/javascript" src="<%=BundleTable.Bundles.ResolveBundleUrl("~/rdp/js/network/eventsource.js", true)%>"></script>
        <script language="javascript" type="text/javascript" src="<%=BundleTable.Bundles.ResolveBundleUrl("~/rdp/js/network/longpolling.js", true)%>"></script>
        <script language="javascript" type="text/javascript" src="<%=BundleTable.Bundles.ResolveBundleUrl("~/rdp/js/network/websocket.js", true)%>"></script>
        <script language="javascript" type="text/javascript" src="<%=BundleTable.Bundles.ResolveBundleUrl("~/rdp/js/network/xmlhttp.js", true)%>"></script>
        <script language="javascript" type="text/javascript" src="<%=BundleTable.Bundles.ResolveBundleUrl("~/rdp/js/user.js", true)%>"></script>
        <script language="javascript" type="text/javascript" src="<%=BundleTable.Bundles.ResolveBundleUrl("~/rdp/js/user/keyboard.js", true)%>"></script>
        <script language="javascript" type="text/javascript" src="<%=BundleTable.Bundles.ResolveBundleUrl("~/rdp/js/user/mouse.js", true)%>"></script>
        <script language="javascript" type="text/javascript" src="<%=BundleTable.Bundles.ResolveBundleUrl("~/rdp/js/user/touchscreen.js", true)%>"></script>
        ...
        <script language="javascript" type="text/javascript" src="<%=BundleTable.Bundles.ResolveBundleUrl("~/node_modules/interactrdp/js/dist/interact.js", true)%>"></script>
