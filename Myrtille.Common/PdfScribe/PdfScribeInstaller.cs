...
namespace Myrtille.PdfScribe
{
    public class PdfScribeInstaller
    {
        ...
        const uint PRINTER_ATTRIBUTE_FAX = 0x00004000;
        const uint PRINTER_ATTRIBUTE_TS = 0x00008000;
        ...
        //const string ENVIRONMENT_32 = "Windows NT x86";   // if needed
        //const string ENVIRONMENT_64 = "Windows x64";
        const string ENVIRONMENT_64 = null;                 // auto-detect the environment
        //const string PRINTERNAME = "PDF Scribe";
        const string PRINTERNAME = "Myrtille PDF";
        ...
        private string MONITORDLL = Environment.Is64BitOperatingSystem ? "redmon64.dll" : "redmon32.dll";
        ...
        */
        ...
        public PdfScribeInstaller(InstallContext installContext): this()
        {
        ...
        {
            if (_installContext != null && !string.IsNullOrEmpty(message))
            {
                _installContext.LogMessage(message);
            }
        }
            ...
            try
            {
                ...
                if (!DoesMonitorExist(PORTMONITOR))
                {
                    ...
                    if (!AddPortMonitor(newMonitor))
                    {
                        ...
                        LogInstallMessage(String.Format("Could not add port monitor {0}", PORTMONITOR) + Environment.NewLine +
                                          String.Format(WIN32ERROR, Marshal.GetLastWin32Error().ToString()));
                ...
                else
                {
                    ...
                    LogInstallMessage(String.Format("Port monitor {0} already installed.", PORTMONITOR));
        ...
        public bool RemovePdfScribePortMonitor()
        {
            ...
            if ((NativeMethods.DeleteMonitor(null, ENVIRONMENT_64, PORTMONITOR)) != 0)
            {
                ...
                if (!DeletePdfScribePortMonitorDll())
                {
                    ...
                    LogInstallMessage("Could not remove port monitor dll.");
        ...
        private bool DeletePortMonitorDll(String monitorDll)
        {
            ...
            catch (Win32Exception windows32Ex)
            {
                ...
                LogInstallMessage(NATIVE_COULDNOTENABLE64REDIRECTION + String.Format(WIN32ERROR, windows32Ex.NativeErrorCode.ToString()));
            ...
            catch (IOException)
            {
                ...
                LogInstallMessage(String.Format(FILENOTDELETED_INUSE, monitorDllFullPathname));
            ...
            finally
            {
                ...
                catch (Win32Exception windows32Ex)
                {
                    ...
                    LogInstallMessage(NATIVE_COULDNOTREVERT64REDIRECTION + String.Format(WIN32ERROR, windows32Ex.NativeErrorCode.ToString()));
                                            ...
                                            String outputHandlerArguments)
        {
            ...
            if (AddPdfScribePortMonitor(driverSourceDirectory))
            {
                ...
                LogInstallMessage("Port monitor successfully installed.");
                ...
                if (CopyPrinterDriverFiles(driverSourceDirectory, printerDriverFiles.Concat(printerDriverDependentFiles).ToArray()))
                {
                    ...
                    LogInstallMessage("Printer drivers copied or already exist.");
                    ...
                    if (AddPdfScribePort())
                    {
                        ...
                        LogInstallMessage("Redirection port added.");
                        ...
                        if (InstallPdfScribePrinterDriver())
                        {
                            ...
                            LogInstallMessage("Printer driver installed.");
                            ...
                            if (AddPdfScribePrinter())
                            {
                                ...
                                LogInstallMessage("Virtual printer installed.");
                                ...
                                if (ConfigurePdfScribePort(outputHandlerCommand, outputHandlerArguments))
                                {
                                    ...
                                    LogInstallMessage("Printer configured.");
                                ...
                                else
                                {
                                    ...
                                    LogInstallMessage(INFO_INSTALLCONFIGPORT_FAILED);
                            ...
                            else
                            {
                                ...
                                LogInstallMessage(INFO_INSTALLPRINTER_FAILED);
                        ...
                        else
                        {
                            ...
                            LogInstallMessage(INFO_INSTALLPRINTERDRIVER_FAILED);
                    ...
                    else
                    {
                        ...
                        LogInstallMessage(INFO_INSTALLPORT_FAILED);
                ...
                else
                {
                    ...
                    LogInstallMessage(INFO_INSTALLCOPYDRIVER_FAILED);
            ...
            else
            {
                ...
                LogInstallMessage(INFO_INSTALLPORTMONITOR_FAILED);
                ...
                while (undoInstallActions.Count > 0)
                {
                    ...
                    try
                    {
                        if (!undoAction())
                        {
                            ...
                            LogInstallMessage(String.Format(INSTALL_ROLLBACK_FAILURE_AT_FUNCTION, undoAction.Method.Name));
                                            ...
                                            String[] filesToCopy)
        {
            ...
            try
            {
                for (int loop = 0; loop < filesToCopy.Length; loop++)
                {
                    ...
                    catch (IOException)
                    {
                        ...
                        LogInstallMessage(String.Format(FILENOTCOPIED_ALREADYEXISTS, fileDestinationPath));
            ...
            { 
                ...
                LogInstallMessage(String.Format(FILENOTCOPIED_PRINTERDRIVER, ioEx.Message));
            ...
            catch (UnauthorizedAccessException unauthorizedEx)
            {
                ...
                LogInstallMessage(String.Format(FILENOTCOPIED_PRINTERDRIVER, unauthorizedEx.Message));
            ...
            catch (NotSupportedException notSupportedEx)
            {
                ...
                LogInstallMessage(String.Format(FILENOTCOPIED_PRINTERDRIVER, notSupportedEx.Message));
        ...
        private bool InstallPrinterDriver(ref DRIVER_INFO_6 printerDriverInfo)
        {
            ...
            if (printerDriverInstalled == false)
            {
                ...
                LogInstallMessage("Could not add PDF Scribe printer driver. " +
                                  String.Format(WIN32ERROR, Marshal.GetLastWin32Error().ToString()));
        ...
        public bool RemovePDFScribePrinterDriver()
        {
            ...
            if (!driverRemoved)
            {
                ...
                LogInstallMessage("Could not remove PDF Scribe printer driver. " +
                                  String.Format(WIN32ERROR, Marshal.GetLastWin32Error().ToString()));
        ...
        private bool AddPdfScribePrinter()
        {
            ...
            pdfScribePrinter.Attributes = PRINTER_ATTRIBUTE_DIRECT;
            ...
            else
            {
                ...
                LogInstallMessage("Could not add PDF Scribe virtual printer. " +
                                  String.Format(WIN32ERROR, Marshal.GetLastWin32Error().ToString()));
        ...
        private bool DeletePdfScribePrinter()
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    LogInstallMessage("Could not delete PDF Scribe virtual printer. " +
                                      String.Format(WIN32ERROR, Marshal.GetLastWin32Error().ToString()));
                                            ...
                                            String argumentsValue)
        {
            ...
            catch (UnauthorizedAccessException unauthorizedEx)
            {
                ...
                LogInstallMessage(String.Format(REGISTRYCONFIG_NOT_ADDED, unauthorizedEx.Message));
            ...
            catch (SecurityException securityEx)
            {
                ...
                LogInstallMessage(String.Format(REGISTRYCONFIG_NOT_ADDED, securityEx.Message));
        ...
        private bool RemovePdfScribePortConfig()
        {
            ...
            catch (UnauthorizedAccessException unauthorizedEx)
            {
                ...
                LogInstallMessage(String.Format(REGISTRYCONFIG_NOT_DELETED, unauthorizedEx.Message));
